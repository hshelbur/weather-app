  ...
  return (
    <Layout>
      ...
      <div className="query">
        ...
        <button className="btn" onClick={(e) => {e.preventDefault(); setNewQuery(`city`)}}>Submit</button>
      </div>
      <div className="query">
        <label htmlFor="zip">Zip Code: </label>
        <input type="text" onBlur={(e) => setZipCode(e.target.value)} />
        <button className="btn" onClick={(e) => {e.preventDefault(); setNewQuery(`zip`)}}>Submit</button>
      </div>
      <form className="query coordinates-form">
        ...
        <button className="btn" onClick={(e) => { e.preventDefault(); setNewQuery(`coordinates`)}}>Submit</button>
      </form>
      {data.main && 
